...
\subsubsection{第十二条\quad委员会的下属部门}\label{ux7b2cux5341ux4e8cux6761-ux59d4ux5458ux4f1aux4e0bux5c5eux673aux6784}}

委员会下属部门是委员会的一部分。委员会下设技术部、运营部和信宣部。

\begin{itemize}
    \item \textbf{技术部}\quad负责维护和开发协会所管理的服务器和其他软硬件设施，开发和实现新的软件需求、举办技术相关技术分享和培训；
    \item \textbf{运营部}\quad负责计划和开展协会日常活动、校企合作，协会招新、换届以及管理协会资产和人员等；
    \item \textbf{信宣部}\quad负责记录协会相关活动、摄影摄像、新闻稿、公众号推文、宣传片、海报、招新和其他宣传物料。
\end{itemize}
